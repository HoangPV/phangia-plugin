...
class Widget_Init {
	...
	public function __construct() {
		...
		add_action('elementor/widgets/widgets_registered', [$this, '_widget_registered']);
		add_action('elementor/editor/after_enqueue_scripts', [$this, 'load_assets_for_elementor']);
		...
		add_filter('elementor/icons_manager/native', [$this, 'add_custom_icon_to_elementor_icons']);
	}
	...
	public function _widget_categories($elements_manager) {
		$elements_manager->add_category([
			'appside_widgets' , [
				'title' => esc_html__('Appside Widgets'),
				'icon' => 'fa fa-plug'
			]
		]);
		...
		$elements_manager->add_category([
			'appside_builder_widgets', [
				'title' => esc_html__('Appside Builder Widgets'),
				'icon' => 'fa fa-plug'
			]
		]);
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script('parallax-scroll', APPSIDE_MASTER_JS . '/jquery.parallax-scroll.js',[], false, true);
		wp_enqueue_script('smoove', APPSIDE_MASTER_JS . '/jquery.smoove.js', null, false, true);
		wp_enqueue_script('parallax', APPSIDE_MASTER_JS . '/parallax.js',[],false, true);
		wp_enqueue_script('countdown', APPSIDE_MASTER_JS . '/jquery.countdown.min.js',[], false, true);
	}
}